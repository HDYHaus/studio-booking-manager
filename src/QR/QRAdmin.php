		...
		<div class="wrap sbm-admin-page">
			...
			$this->render_query_notice(
				array(
					...
					'expired_qr'     => __( 'That QR code has expired. Regenerate the person QR token to create a fresh code.', 'studio-booking-manager' ),
				)
			);
			?>
	...
	private function render_person_qr(): void {
		...
		<div class="wrap sbm-admin-page">
			...
			<div class="sbm-card sbm-qr-output">
				...
				<noscript><p><?php echo esc_html__( 'Enable JavaScript to render QR codes.', 'studio-booking-manager' ); ?></p></noscript>
