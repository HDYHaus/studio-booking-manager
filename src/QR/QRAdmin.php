...
final class QRAdmin extends AbstractAdminPage {
	...
	private function render_person_qr(): void {
		...
		?>
		<div class="wrap sbm-admin-page <?php echo $is_print_view ? 'sbm-qr-print-view' : ''; ?>">
			...
			<div class="sbm-card sbm-qr-output">
				<div class="sbm-qr-code"><?php echo $svg; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- SVG is generated by QRService. ?></div>
	...
	private function download_filename( object $person ): string {
		return sanitize_title( (string) $person->display_name ) . '-qr.svg';
	}
